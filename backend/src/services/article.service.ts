...
export class ArticleService {
  ...
  static async getMyArticles(authorId: string, query: any) {
  ...
  static async delete(articleId: string, authorId: string) {
    const article = await prisma.article.findUnique({
      where: { id: articleId },
    });
  ...
  static async getPublicFeed(query: any) {
  ...
  static async getAuthorDashboard(authorId: string, query: any) {
